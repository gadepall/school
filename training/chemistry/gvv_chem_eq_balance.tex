...
\begin{lstlisting}
svn co https://github.com/gadepall/school/trunk/training\end{lstlisting}
...
\end{align}
%
Substituting $x_4 = 4$ in \eqref{eq:chem_balance_mat_sol}, 
\begin{align}
\label{eq:chem_balance_mat_ans}
\vec{x} = \myvec{3 \\ 4 \\ 1 \\ 4}
\end{align}
%
and \eqref{eq:chem_balance_unsol} becomes
