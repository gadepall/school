...
\begin{figure}[!ht]
	\begin{center}
		...
		%\vspace*{-10cm}
		\resizebox{\columnwidth}{!}{\input{./figs/fig_2.4.tex}}
	\end{center}
...
\begin{figure}[!ht]
	\begin{center}
		...
		%\vspace*{-10cm}
		\resizebox{\columnwidth}{!}{\input{./figs/fig_2.7.tex}}
	\end{center}
...
\begin{figure}[!ht]
	\begin{center}
		...
		%\vspace*{-10cm}
		\resizebox{\columnwidth}{!}{\input{./figs/fig_2.11.tex}}
	\end{center}
...
\begin{figure}[!ht]
	\begin{center}
		...
		%\vspace*{-10cm}
		\resizebox{\columnwidth}{!}{\input{./figs/fig_2.15.tex}}
	\end{center}
	\caption{Medians meet at a point}
	\label{ch2_median_final}	
\end{figure}

\proof Since BE is a median, the areas of  triangles  $\triangle BEC$ and $\triangle BEA$ are equal. Hence,
\begin{align}
