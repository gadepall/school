...
\begin{abstract}
%\boldmath
The objective of the manual is to introduce the RaspberryPi to beginners by programming the GPIO pins to
build a decade counter .
% covers the entire breadth of digital design b
% y building a decade counter using a Raspberry Pi.  In
%  the process, boolean logic, combinational logic and s
%  equential logic are covered.
\end{abstract}
%\newpage
