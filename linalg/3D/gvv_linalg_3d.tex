...
This manual introduces linear algebra by exploring 3D geometry using a problem solving approach.
\end{abstract}
...
\end{equation}
respectively. Find the normal to the plane spanned by $L_1$ and $L_2$.
\\
\solution The normal is obtained as
\begin{align}
