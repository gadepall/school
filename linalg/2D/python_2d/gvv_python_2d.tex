...
\item Show that 
\begin{align}
r = \frac{\abs{\brak{\vec{B}-\vec{C}}^T\brak{\vec{I}-\vec{B}}}}{\norm{\vec{B}-\vec{C}}}
\end{align}
\solution Since $\vec{U}$ lies on $BC$,
\begin{align}
\vec{U} = \vec{B} + \lambda\brak{\vec{B}-\vec{C}}
\end{align}
...
\solution Since $\vec{U}$ lies on $BC$,
\begin{align}
\vec{n}_{BC}^T\brak{\vec{U}-\vec{B}} = 0
\end{align}
%
where $\vec{n}_{BC}$ is the normal vector of $BC$.  Sinc $IU \perp BC$, 
\begin{align}
\vec{B-C}^T = \vec{B}+\lambda\brak{\vec{B}-\vec{A}}
\end{align}
%
Since $\vec{U}$ lies on the circle, 
\begin{align}
\brak{\vec{U} -\vec{I}}^T \brak{\vec{U} -\vec{I}} = c^2
\end{align}
