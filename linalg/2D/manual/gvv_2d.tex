...
\begin{equation}
\vec{x}^T\myvec{1 & 0 \\ 0 & 0}\vec{x} + \myvec{0 & -1}\vec{x} + 6 = 0
\end{equation}
\\
\solution Substituting
\begin{equation}
\vec{p} = \myvec{1 \\ 7}, V = \myvec{1 & 0 \\ 0 & 0}, \vec{u} = \myvec{0 \\ -1}
\end{equation}
%
in \eqref{eq:tangent}, the desired equation is
\begin{multline}
\sbrak{\myvec{ 1 & 7}\myvec{1 & 0 \\ 0 & 0}+\myvec{0 & -1}}\vec{x} 
\\
+ \myvec{ 1 & 7}\myvec{0 \\
-1} 
+6 = 0
...
touches the circle
\begin{equation}
\vec{x}^T\myvec{1 & 0\\ 0 & 1}\vec{x} + 4 \myvec{4 & 3}\vec{x} + c = 0
\end{equation}
Find $c$.
\end{enumerate}
\end{document}
