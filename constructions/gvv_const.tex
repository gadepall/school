...
\begin{enumerate}[label=\thesection.\arabic*
,ref=\thesection.\theenumi]
\item Now redraw $\triangle ABC$ as $\triangle PQR$ with 
\begin{align}
\label{eq:rt_triang_orig}
\vec{O}=\frac{\vec{P}+\vec{R}}{2}=\myvec{0 \\0}
\end{align}
\\
\solution The coordinates of the $\triangle PQR$ are
\begin{align}
...
\end{align}
%
\item Find $r$ such that $\vec{O}$ is equidistant from $\vec{P}, \vec{Q}$ and $\vec{R}$.
\\
\solution We have 
