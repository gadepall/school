...
\label{fig:triangle}
\end{figure}
\item In $\triangle ABC$,  $a = 7, \angle B = 75^{\degree}$ and $b+c = 13$. If 
\begin{align}
...
triangle.
\\
\solution The solution of any equation of the form
\begin{align}
px^2+qx+r = 0
\end{align}
is given by 
...
circle.
\\
\solution From the given information, $AC \perp BC, a = 10$ and $c = 6$.
\begin{align}
b =  \sqrt{a^2-c^2}
\end{align}
