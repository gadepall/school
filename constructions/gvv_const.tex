...
units.
\\
\solution Take the centre of both circles to be at the origin.  For any angle $\theta$, a point on the circle with radius 6 has coordinates
\begin{align}
6\myvec{\cos \theta\\ \sin\theta}
\end{align}
