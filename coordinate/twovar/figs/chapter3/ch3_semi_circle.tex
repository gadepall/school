\begin{tikzpicture}
 ...
 \coordinate [point, label={below :	$B$ $\brak{0,0}$}] (B) at (-1, 0);
 \coordinate [point, label={below right:	$O$ $\brak{r,0}$}] (O) at (0, 0);
 \coordinate [point, label={below right:	$C$ $\brak{2r,0}$}] (C) at (1, 0); 
 \coordinate [point, label={above left:	$A$ $\brak{a,b}$}] (A) at (-0.707,0.707);  
