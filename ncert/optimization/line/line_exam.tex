...
\end{align}
%
from \eqref{eq:opt_line_dist_nor}, where $\mu$ is some constant.
...
\end{align}
upon substituting from \eqref{eq:opt_line_dist_uncon_mu}. The distance between $\vec{P}$ and ${L}$ is thenfrom \eqref{eq:opt_line_dist_uncon_f} as
 obtained as 
\begin{align}
