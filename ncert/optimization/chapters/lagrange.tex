...
\end{align}
%
and find $\vec{x}_{\min} = \vec{Q}  = \myvec{2.64\\-4.52},
$ that minimizes $r$. By labeling  $\vec{Q}$ in Fig. \ref{fig:concirc}, show that $\vec{Q}$ is the point of contact of the line $L$ with the circle of minimum radius $r = \frac{3}{5}$.
