...
\end{align} 
%\item ({\em Conjugate Hyperbola:}) Another hyperbola with the same asymptotes as \eqref{eq:quad_form_pair} can be obtained by rotating the hyperbola with the angle in \eqref{eq:quad_form_pair_ang} and the rotation matrix 
%\begin{align}
%\label{eq:quad_form_pair_ang_rot}
%\vec{Q} = \myvec{
%\cos \theta & -\sin \theta
%\\
%\sin \theta & \cos \theta 
...
%where 
%\begin{align}
%\sin \theta = 2\frac{\sqrt{\abs{\lambda_1}\abs{\lambda_2}}}
%{\abs{\lambda_1}+\abs{\lambda_2}}
%\end{align}
%%
%The equation of the conjugate hyperbola is then obtained as\begin{align}
