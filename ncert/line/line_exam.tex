...
%
\solution Both the lines have the same direction vector, so the lines are parallel. From Fig. \ref{fig:line_dist_parallel}, the distance is
%
\begin{figure}
\centering
...
\end{align}
%
The above matrix has $rank = 3$.  Hence, the lines do not intersect.  Note that the lines are not parallel but they lie on parallel planes.  Such lines are known as {\em skew} lines.  The normal to both the lines (and corresponding planes) is 
%
\begin{align}
