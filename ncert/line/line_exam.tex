...
%
\\
\solution The direction vectors of the lines are \myvec{1 \\ 2 \\2} and \myvec{3 \\ 2 \\6}.   Using\eqref{eq:line_inner_prod}, the angle between the lines can be obtained. 
...
%
\\
\solution From Problem \ref{prob:line_3d}, the direction vectors of the lines can be expressed as \myvec{3\\5\\4} and \myvec{1\\1\\2}.  The angle between them can then be obtained from \eqref{eq:line_inner_prod}.
%
\item If 
$\vec{a}=\myvec{5\\-1\\-3}$
  and 
...
Thus, 
\begin{align}
\vec{n} = \myvec{\frac{1}{2}\\\frac{-3}{4}\\1} = \myvec{2\\-3\\4}
\end{align}
