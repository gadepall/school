...
\item (ii) earning \rupee 16000 or more per month and owning exactly 1 vehicle.\\
\item (iii) earning less than \rupee 7000 per month and does not own any vehicle.\\
\item (iv) earning \rupee 13000 – \rupee 16000 per month and owning more than 2 vehicles.\\
\item (v) owning not more than 1 vehicle.\\
\end{enumerate}
