...
\\
\solution 
\input{./solutions/1/chapters/circle/solution.tex}
\item Find the centre $O$ of a circle passing through the points \myvec{6\\-6}, \myvec{3\\-7} and  \myvec{3\\3}.
\solution 
\input{./solutions/2/chapters/circle_ex/solution.tex}
...
\end{enumerate}
\solution 
\input{./solutions/3/chapters/circle2/solution.tex}
...
%\\
%\solution 
%\input{./solutions/4/chapters/circle/solution.tex}
...
\\
\solution 
\input{./solutions/6/chapters/circle/solution.tex}
...
\solution 
\input{./solutions/7/chapters/circle/solution.tex}
