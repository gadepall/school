...
\end{enumerate}
\solution 
\input{./solutions/1/chapters/conics/solution.tex}
...
%
\solution 
\input{./solutions/2/chapters/conics_ex/solution.tex}
...
\end{enumerate}
\solution 
\input{./solutions/3/chapters/conic2/solution.tex}
...
\end{enumerate}
\solution 
\input{./solutions/4/chapters/conics/solution.tex}
...
\end{enumerate}
\solution 
\input{./solutions/6/chapters/conics/solution.tex}
\item Find the roots of the following quadratic equations
\begin{enumerate}
\item 	$2x^2-7x+3 = 0$
\item 	2$x^2+x-4 = 0$
...
\end{enumerate}
\solution 
\input{./solutions/7/chapters/conics/solution.tex}
