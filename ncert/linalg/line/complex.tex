...
\\
\solution 
\input{./solutions/1/chapters/line/complex/solution.tex}
\item Find $\myvec{-\sqrt{3}\\ \sqrt{2}} \myvec{2\sqrt{3} \\ -1}$.
\\
\solution 
\input{./solutions/2/chapters/line_ex/complex_ex/solution.tex}\item Find the multiplicative inverse of $\myvec{2\\-3}$.
\\
\solution
\input{./solutions/3/chapters/line/comp/solution.tex}
...
\\
\solution 
\input{./solutions/5/chapters/lines/docq8.tex}
\item Find the conjugate of $\frac{\myvec{3 \\ -2}\myvec{2 \\ 3}}{\myvec{1 \\ 2}\myvec{2 \\ -1}}$.
\\
\solution
\input{./solutions/6/chapters/line/complex_numbers/solution.tex}
...
\end{enumerate}
\solution
\input{./solutions/7/chapters/line/complex/solution1.tex}
...
\\
\solution 
\input{./solutions/complex/10/latex/solution.tex}
%
