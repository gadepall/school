...
\solution 
\input{./solutions/matrix/7/solution.tex}
...
\solution 
\input{./solutions/matrix/24_1/solution.tex}
\input{./solutions/matrix/24_2/solution.tex}
\item Find $A^{2}-5A+6I$,if A = \myvec{2 &0 &1\\2 &1 &3\\1 &-1 &0}\\
\solution 
\input{./solutions/matrix/25/solution.tex}
\item If A=\myvec{1 &0 &2\\0 &2 &1\\2 &0 &3},prove that $A^3-6A^2+7A+2I=0$\\
\solution 
\input{./solutions/matrix/26/Latex/solution.tex}
\item If A=\myvec{3 &-2\\4 &-2} and I=\myvec{1 &0\\0 &1},find k\\
 so that $A^2=kA-2I$\\
\solution 
\input{./solutions/matrix/27/solution.tex}
...
\solution 
\input{./solutions/matrix/28/solution.tex}
...
\solution 
\input{./solutions/matrix/29/solution.tex}
...
\solution
\input{./solutions/matrix/59/solution.tex}
  \item \myvec{1 &3 &-2\\-3 &0 &-5\\2 &5 &0}\\
\solution
\input{./solutions/matrix/60/solution.tex}
...
\solution
\input{./solutions/matrix/70/solution.tex}
...
\\
\solution
%\input{./solutions/matrix/73/solution.tex}
