...
\begin{align}
\myvec{2 & 1 \\ -1 & -1 \\ -2 & 3}\vec{x}  &\succeq \myvec{4\\-3 \\ -6}
\end{align}
%
and expressed pairwise as
\begin{align}
\myvec{2 & 1 \\ -1 & -1 }\vec{x}  &\succeq \myvec{4\\-3 }
\\
\myvec{ -1 & -1 \\ -2 & 3}\vec{x}  &\succeq \myvec{-3 \\ -6}
\\
\myvec{2 & 1  \\ -2 & 3}\vec{x}  &\succeq \myvec{4\\ -6}
\end{align}
