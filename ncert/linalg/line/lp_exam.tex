...
\vec{x} \preceq \myvec{60\\-10\\0\\0\\0}
\label{eq:lp_constr}
\end{align}
\solution The region in \eqref{eq:lp_constr} is shown in Fig. \ref{}
\item Solve
\begin{align}
