...
\item E and F are points on the sides PQ and PR respectively of a ∆ PQR. For each of the following cases, state whether EF || QR : 
\begin{enumerate}
...
\item  $∆ ODC ~ ∆ OBA, ∠ BOC = 125°$ and $∠ CDO = 70°$. Find $∠ DOC, ∠ DCO$ and $∠ OAB$.
\end{enumerate}
%
