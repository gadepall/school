...
\solution From \eqref{ch5_circle_squeeze_eq} and \eqref{eq:sin2x},
	%
{\small
	\begin{align}
...
\solution 
%
From Fig. \eqref{ch5_circle_squeeze}, using the fact that the inner and outer polygons converge into a circle for large $n$,
\begin{align}
%\label{eq:peri_poly_n}
