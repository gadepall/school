...
\begin{abstract}
This book provides an equation based  approach to school geometry based on the NCERT textbooks from Class 6-12.  
\end{abstract}
...
\input{./chapters/tri_ineq}
%\newpage
\section{Triangle Exercises}
\input{./chapters/tri_exer_geo}
%\newpage
\section{Quadrilateral Exercises}
\input{./chapters/quad_exer_geo}
